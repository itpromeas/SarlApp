        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SarlUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHeaders_AspNetUsers_SarlUserId",
                        column: x => x.SarlUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_SarlUserId",
                table: "OrderHeaders",
                column: "SarlUserId");
        }
