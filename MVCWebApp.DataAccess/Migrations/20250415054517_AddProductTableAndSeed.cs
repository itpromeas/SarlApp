    ...
    public partial class AddProductTableAndSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Author", "Description", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[,]
                {
                    { 1, "Ange", null, 1.0, 10.0, 7.5, 9.0, "Product 1" },
                    { 2, "Salome", null, 1.0, 2210.0, 1557.5, 2000.0, "Product 2" }
                });
        }
